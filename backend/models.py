...
class MedicalData(db.Model):
    ...
    # Vital Signs
    body_temperature = db.Column(db.Float, nullable=False)  # C
...
class SystemLog(db.Model):
    ...
    timestamp = db.Column(db.DateTime, default=datetime.utcnow, nullable=False, index=True)
    log_metadata = db.Column(db.Text)  # JSON
    
    @staticmethod
    def log(level, source, message, user_id=None, ip_address=None, log_metadata=None):
